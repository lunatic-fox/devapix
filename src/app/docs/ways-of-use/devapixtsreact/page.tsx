...
export default function Page() {
  return (
    <Docs refs={{
      ...
      <p>
        To use Devicon icons with TypeScript React just install <Code ic='@devapix/ts-react' /> npm package.
      </p>
      <Code c='npm i @devapix/ts-react' />
      <p>
        After installation, the next step is to import the module to your project <Code ic='.tsx' /> file.
      </p>
      <Code h='tsx' c={`import Devicon from '@devapix/ts-react'`} />
      ...
      <ReqResExample title={false} reqs={['typescript']} />
      ...
      <ReqResExample title={false} reqs={['rust&pv=2.15.1&v=p&c=3ab048&s=64']} />
      ...
      <ReqResExample title={false} reqs={['chakraui&pv=dev&v=p&t=d&s=64']} />
    </Docs>
  )
}
